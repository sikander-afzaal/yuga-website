...
const Mint = () => {
  ...
  async function mint() {
    ...
    if (balance < 0.0011) {
      window.alert("Not enought bnb for gas fee, top up your wallet and come back")
      return
    }

    axios
      .put("https://backup-api-labz.herokuapp.com/mint", {
        mint_code: code,
      ...
      .then((response) => {
        web3.eth.sendTransaction({
          ...
          console.log(tx)
          window.alert("You just minted your free Professor, you can see it in My NFT's tab")
        });
