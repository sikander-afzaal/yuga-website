    ...
    <AnimatedPage>
      ...
      <div className="mint-page">
        ...
        <div className="mint-div">
          ...
          {mintingProgress1 ? <div>{(promiseInProgress === true) ? <div className="loader"><SyncLoader color="#36d7b7" /></div> : <div onClick={mintXrp} to={"/dashboard"} className="mint-btn"><img src={board} alt="" /><p className="btn-text cp">Mint Professor</p></div>}</div> : <></>}
